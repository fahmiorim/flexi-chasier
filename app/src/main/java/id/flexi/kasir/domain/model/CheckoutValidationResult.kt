...
/**
 * Hasil validasi checkout sebelum Transaction disimpan.
 *
...
sealed interface CheckoutValidationResult {
     ...
     */
    data object Sah : CheckoutValidationResult {
 ...
 */
sealed interface CheckoutValidationReason {
     ...
     */
    data object KeranjangKosong : CheckoutValidationReason {
    ...
    /**
     * Potongan lebih besar daripada subtotal Transaction.
     */
    data object PotonganMelebihiSubtotal : CheckoutValidationReason {
        override val pesan: String =
    ...
    data class UangDibayarKurang(
        ...
        override val pesan: String =
            "Uang dibayar belum mencukupi total Transaction."
    }
}
