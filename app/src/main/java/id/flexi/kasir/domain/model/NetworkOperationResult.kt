 ...
 */
sealed interface NetworkOperationResult<out T> {
    /**
     ...
     */
    data class GagalServer(val kode: Int, val pesan: String) : NetworkOperationResult<Nothing>

    /**
     * Gagal namun aplikasi berhasil menggunakan data cadangan dari lokal.
     */
    data class FallbackLokal<T>(val data: T, val alasanGagal: String) : NetworkOperationResult<T>
}
